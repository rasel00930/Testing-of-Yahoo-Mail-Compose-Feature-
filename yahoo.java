...
public class yahoo 
{
			public static void main(String[] args) throws InterruptedException
		{
			...
			driver.findElement(By.xpath("//input[@name='username']")).sendKeys("raselahmed9141@yahoo.com");//mail_id
			Thread.sleep(2000);
			...
			Thread.sleep(1000);
			driver.findElement(By.xpath("//input[@id='message-to-field']")).sendKeys("raselahmed30609@gmail.com");//to 
